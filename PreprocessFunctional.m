function [] = PreprocessFunctional(subjids)
...
for i=1:x;
    ...
    functDir = ['/data/fmri/gesture/data/SPM8/',subjid,'/functional/data_4_analysis/'];
%     outDir = [functDir,
    structDir = ['/data/fmri/gesture/data/SPM8/',subjid,'/structural/'];
